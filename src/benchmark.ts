...
const benchmark = async () => {
  ...
  MetricsUtil.saveMetricsToJson(executionTimeMetrics, 'docs/public/results/bundler-execution-time-comparison.json');
  console.log('JSON data saved to docs/public/results/bundler-execution-time-comparison.json');
  MetricsUtil.saveMetricsToJson(heapUsageMetrics, 'docs/public/results/bundler-heap-usage-comparison.json');
  console.log('JSON data saved to docs/public/results/bundler-heap-usage-comparison.json');
};
